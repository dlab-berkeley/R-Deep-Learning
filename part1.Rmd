...
Then, grayscale pixel values that range from between 0 (black end of the color spectrum) to 255 (white end of the color spectrum) are scaled to values between 0 and 1. The model uses this binary matrix to help determine the shape of the image from a pixelated perspective. 
```{r}
# rescale
x_train <- x_train / 255
x_test <- x_test / 255
