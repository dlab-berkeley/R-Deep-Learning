...
ez_import = function(file_path) {
  ...
  # Build the for-loop
  # CK: dir() should be passed as a function argument, not used within the function.
  for (i in 1:length(dir())) {
    ...
    # CK: this is not a good practice, instead should compile results into a
    ...
    # CK: also should compile into a list.
