...
## Challenge 1
Why were our loss and accuracy metrics so jumpy? What are the differences between training and validation datasets? What could be done to improve model performance do you think? 

## Challenge 2 (take home)
Can you recapitulate what you learned in parts 1 and 2 and repeat this process on the [FashionMNIST](https://www.kaggle.com/zalando-research/fashionmnist/home) dataset? 
