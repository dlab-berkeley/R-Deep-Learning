...
Recapitulate what you learned in parts 1 and 2 and fit a deep neural network on the [FashionMNIST](https://keras.io/datasets/#fashion-mnist-database-of-fashion-articles) dataset. How are these data stored? Are they actual images? How can we read them into keras in R? 
