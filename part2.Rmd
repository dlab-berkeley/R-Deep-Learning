...
# Define our batch size, or number of training observations for each epoch, as 150
batch_size = 150L

# Define the number of images in our training dataset to be used (600)
...
## Challenge
How can we improve performance when the nomenclature and vocabulary feels so complicated? [Read this excellent post](https://blog.slavv.com/37-reasons-why-your-neural-network-is-not-working-4020854bd607) to learn more. Try tuning some of our model (hypter)parameters to see if you can improve model performance. 
