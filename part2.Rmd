...
# Define our batch size, or number of training observations for each epoch, as 100
batch_size = 100L
...
# Define the number of images in our validation dataset to use (50)
num_validation_samples = 50L
