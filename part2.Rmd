...
# EM error: Error in py_call_impl(callable, dots$args, dots$keywords) : 
#   ValueError: Error when checking input: expected flatten_1_input to have 4 dimensions, but got array with shape (10000, 784) 
