...
---
# So how does it work? 
1. Supervised neural networks require "features", or an **input layer** of data that is used to produce our estimated **output layer**, or estimation of an actual image.  
...
5. The vector of original weights is added to the updated weights and are "backpropagated" (used as the recycled input) and passed through the model for another epoch.  
