...
Or, use Bash to git clone: `$ git clone git@github.com:dlab-berkeley/Deep-Learning-in-R.git`
...
Part 1
# `array_reshape`
Arguments we should define: 

**Array:** training or test set

**3D vector:** containing  
  1) Number of rows in train/test set  
  2) Image height  
  3) Image width  
...
**Number of Y classes:** 10; number of Y classes
...
**Input layer:**  
  ...
  `layer_dense`  
    **Units:** number of neurons in the input layer  
    **Activation function:** "relu"  
    **Input shape:** dimensions of the images  
  `layer_dropout`  
    **Rate:** more or less?  

**Hidden layer:** Same as input layer, minus **Input shape.**  

**Output layer:** Just need **Units** and **Activation function.**
...
Part 2
# `flow_from_directory`
**File path:** to training and test data  
**Image shape:**  
**Batch size:**  
...
# `fit_generator`
Training model configuration (using `flow_from_directory`)  
**Steps per epoch:**  
**Epochs:**  
**Validation data:**  
**Validation steps:**  
