...
Part 1
# `data_mnist`
[Load the MNIST dataset](http://yann.lecun.com/exdb/mnist/) using the built-in function and assign the training and test X and Y variables: 
...
- Activation function: how to determine the output of a node (e.g., relu, sigmoid).  
